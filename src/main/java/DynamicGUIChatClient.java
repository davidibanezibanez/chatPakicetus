...
public class DynamicGUIChatClient {
    private static final String SERVER_IP = "181.160.232.90";
    ...
    private void initializeGUI() {
        frame = new JFrame("Chat Pakicetus por David Ibáñez");
        ...
        JLabel nicknameLabel = new JLabel("¿Cómo te llamaremos aquí en Chat Pakicetus?");
        ...
        JButton nicknameButton = new JButton("¡A chatear!");
    ...
    private void handleNicknameInput() {
        ...
        if (!inputNickname.isEmpty()) {
            ...
            frame.setTitle("Ya estás en Chat Pakicetus " + nickname + "!");
            CardLayout cardLayout = (CardLayout) cardsPanel.getLayout();
            cardLayout.show(cardsPanel, "chatPanel");
            inputField.requestFocus();
        } else {
            JOptionPane.showMessageDialog(frame, "Por favor ingrese un nickname.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
